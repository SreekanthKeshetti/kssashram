...
//   FaClipboardList,
//   FaUsers,
//   FaChalkboardTeacher, // Icon for Faculty
//   FaBuilding,
//   FaPhone,
//   FaTrash,
//   FaUserPlus,
...
//   // Create Event Form Data (Updated with Faculty)
...
//   // --- HANDLERS (Keep existing logic for Reg/Attendance) ---
...
//     // Check if field belongs to faculty
//     if (
...
//             >
//               <FaPlus className="me-2" /> Add New Training
//             </Button>
//           </div>
//         </Col>
//       </Row>
...
//       {/* ATTENDANCE MODAL (Same as before, just kept for completeness) */}
//       <Modal
//         show={showAttendanceModal}
//         onHide={() => setShowAttendanceModal(false)}
//         size="lg"
//       >
//         {/* ... (Keep existing attendance modal logic) ... */}
//         <Modal.Header closeButton>
...
const EventList = () => {
  ...
  return (
    <div>
      ...
      {/* ATTENDANCE MODAL (Updated with Export Button) */}
      <Modal
        show={showAttendanceModal}
        onHide={() => setShowAttendanceModal(false)}
        size="lg"
