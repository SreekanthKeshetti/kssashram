                ...
                {donations.map((d) => (
                  <tr key={d._id}>
                    ...
                    <td>
                      ...
                      {/* Show Special Occasion if it exists */}
                      {d.occasion && (
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Row>
              ...
              <Col md={6} className="mb-3">
                <Form.Label>
                  Ashram Unit / Branch <span className="text-danger">*</span>
                </Form.Label>
                <Form.Select
                  name="branch"
              ...
              <hr />
              <h6 className="text-maroon">
                Special Occasion Details (Optional)
              </h6>
              <Row className="mb-3">
                <Col md={4}>
                  <Form.Label>Occasion / Purpose</Form.Label>
                  <Form.Select
                    name="occasion"
                ...
                <Col md={4}>
                  <Form.Label>In Name Of / Memory Of</Form.Label>
                  <Form.Control
                    type="text"
                    name="inNameOf"
                ...
                <Col md={4}>
                  <Form.Label>Seva/Program Date</Form.Label>
                  <Form.Control
                    type="date"
                    name="programDate"
